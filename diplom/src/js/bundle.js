...
function addMore() {
  ...
  var hideStiles = document.querySelectorAll('.styles-2');
  buttonStyles.addEventListener('click', function () {
    buttonStyles.style.display = "none";

    for (var i = 0; i < hideStiles.length; i++) {
...
/***/ "./src/js/parts/gorizontalSlider.js":
/*!******************************************!*\
  !*** ./src/js/parts/gorizontalSlider.js ***!
  \******************************************/
/*! exports provided: default */
...
function gorizontalSlider() {
  ...
  var prev = document.querySelector('.main-prev-btn');
  var next = document.querySelector('.main-next-btn');
  ...
  function showSlides(n) {
    ...
    slides[slideIndex - 1].style.display = 'block'; // slides[slideIndex - 1].classList.add("animated");
...
function modal() {
  ...
  var overlay = document.querySelector('.popup-design');
  var popupConsultation = document.querySelector('.popup-consultation');
  var close = document.querySelectorAll('.popup-close');
  var getDesignInput = document.querySelectorAll('.getDesign input');
  var getDesignTextarea = document.querySelector('.getDesign textarea');
  var orderBtn = document.querySelectorAll('.button-design');
  var descriptionBtn = document.querySelectorAll('.button-consultation');
  ...
  for (var _i = 0; _i < close.length; _i++) {
    close[_i].addEventListener('click', function () {
      ...
      popupGift.style.display = 'none'; //     document.body.style.overflow = '';

      insideForm.style.display = "block";
      insideFormH4.style.display = "block";
      insideFormFile.style.display = "block";

      for (var _i2 = 0; _i2 < getDesignInput.length; _i2++) {
        getDesignInput[_i2].value = "";
      }
  ...
  for (var _i3 = 0; _i3 < descriptionBtn.length; _i3++) {
    descriptionBtn[_i3].addEventListener('click', function () {
      popupConsultation.style.display = 'block'; //   this.classList.add('more-splash');
      //  document.body.style.overflow = 'hidden';
    });
  } //подарок
